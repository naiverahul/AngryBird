...
//         table.add(soundButton).pad(15).width(200).height(100);
//         table.row();
//         table.add(graphicsButton).pad(15).width(200).height(100);
//         table.row();
//         table.add(controlsButton).pad(15).width(200).height(100);
//         table.row();
//         table.add(backButton).padTop(15).width(100).height(100);
//     }
...
public class SettingsScreen implements Screen {
    ...
    public SettingsScreen() {
        ...
        stage = new Stage(viewport);
        s_background = new Texture(Gdx.files.internal("setting_background.png"));
