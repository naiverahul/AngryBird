...
// public class old_game_screen implements Screen, Serializable {
...
//     public old_game_screen(MyGame game) {
...
//                 }
//                 if ((a.getBody().getUserData() instanceof Bird && b.getBody().getUserData() instanceof block_struct) ||
//                 (a.getBody().getUserData() instanceof block_struct && b.getBody().getUserData() instanceof Bird))
