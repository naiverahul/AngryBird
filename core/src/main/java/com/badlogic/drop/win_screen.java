...
public class win_screen implements Screen{
    ...
    public win_screen(MyGame w_orignal_game_variable) {
        ...
        this.w_background = new Texture("win_screen_original.png");
        this.w_music = Gdx.audio.newMusic(Gdx.files.internal("win_sound.wav"));
